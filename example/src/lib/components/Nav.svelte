...
>
  ...
  >
    <div class="flex items-center gap-3">
      <a
        href="/"
        class="font-semibold tracking-tight text-zinc-100 hover:text-zinc-200 transition-colors flex items-center gap-2"
      >
        <div
          class="w-8 h-8 rounded-lg bg-linear-to-br from-orange-500 to-amber-600 flex items-center justify-center"
        >
          <svg
